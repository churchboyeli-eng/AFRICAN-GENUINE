            ...
            >
              {dayTripFilters.map((f) => (
                <button
                  ...
                  className={`rounded-pill px-5 py-3.5 md:py-2.5 font-body text-[12px] font-bold transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-gold ${
                    filter === f
