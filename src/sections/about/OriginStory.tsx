...
export default function OriginStory() {
  return (
    <section className="py-28 border-b border-[rgba(33,29,26,0.22)] bg-ovl-bg" aria-label="Our origin story">
      <div className="shell">
        <div className="grid gap-16 lg:gap-20 lg:grid-cols-2 items-center">
          ...
          <FadeUp className="order-1 lg:order-2">
            ...
            <a
              href="/itineraries"
              className="inline-flex items-center gap-2 font-body text-[14px] font-bold text-ovl-accent hover:text-[#a83a20] transition-colors focus:outline-none focus-visible:underline"
            >
