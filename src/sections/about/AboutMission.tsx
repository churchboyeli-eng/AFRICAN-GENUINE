...
export default function AboutMission() {
  return (
    <section className="py-28 border-b border-[rgba(33,29,26,0.22)] bg-ovl-bg" aria-label="Our mission">
      <div className="shell">
        <div className="grid gap-16 lg:gap-20 lg:grid-cols-2 items-center">
          ...
          <FadeUp>
            ...
            <h2 className="font-display text-[clamp(30px,4vw,52px)] font-extrabold tracking-tighter text-[#211d1a] leading-tight mb-8">
