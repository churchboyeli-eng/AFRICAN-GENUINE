...
export default function GeniusFamily() {
  return (
    <section className="py-28 border-b border-[rgba(33,29,26,0.22)] bg-ovl-bg" aria-label="The African Genuine family">
      <div className="shell">
        <div className="grid gap-16 lg:gap-20 lg:grid-cols-2 items-center">
          ...
          <FadeUp delay={0.12}>
            ...
            <p className="text-[#5c5750] text-[16px] leading-[1.85]">
