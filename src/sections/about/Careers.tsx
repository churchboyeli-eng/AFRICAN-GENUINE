...
export default function Careers() {
  return (
    <section className="py-24 border-b border-line" aria-label="Join our team">
      <div className="shell">
        <FadeUp>
          <div className="grid lg:grid-cols-2 gap-12 items-end">
            <div>
              <p className="eyebrow mb-5">Work with us</p>
              <h2 className="font-display text-[clamp(28px,4vw,46px)] font-extrabold tracking-tighter text-cream leading-tight">
