...
export default function PlanCTA() {
  return (
    <section className="py-36 text-center" aria-label="Plan your safari">
      <div className="shell">
        <FadeUp>
          <div className="gold-rule w-16 mx-auto mb-8" />
          <p className="eyebrow mb-5 tracking-wider2">Ready to travel?</p>
          <h2 className="font-display text-[clamp(34px,5.5vw,72px)] font-extrabold tracking-tighter text-cream leading-tight max-w-2xl mx-auto mb-6">
            Let&rsquo;s design<br />your Tanzania.
          </h2>
          <p className="text-sand text-[16px] leading-relaxed max-w-lg mx-auto mb-12">
