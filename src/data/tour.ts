...
export type Day = { n: number; title: string; place: string; travel: string; stay: string; meals: string; desc: string };
...
export type Lodge = { nights: string; stars: string; name: string; desc: string; image: string };
...
export type Departure = { window: string; note: string; avail: string; availColor: string; price: string };
